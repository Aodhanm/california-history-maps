...
features = [
    ...
    F("pu-san-jose", "Pueblo San José de Guadalupe", [37.3382, -121.8863], "exact", "settlement", "pueblos",
      ...
      [["1790", "78 souls (1 europeo, 33 espanoles, 8 indios, 8 mulatos, 28 otras castas)", "C-A 50 Doc 20; nominal roll Doc 19"],
       ["early 1830s", "602 inhabitants: 431 gente de razon + 171 indigenas avecindados", "St. Pap. M&C (C-A 53) Doc 49"]],
    ...
    F("pu-los-angeles", "Pueblo de Los Ángeles", [34.0537, -118.2428], "exact", "settlement", "pueblos",
      ...
      notes="The 1828 vs 1830 drop reflects changing padron scope as much as population; both are shown as recorded.",
...
M = [
 ...
 ("San Gabriel", [34.0967, -118.1067],
  [["1784","739","C-A 50 Doc 8"],["1788","~1,000","Doc 16"],["1789","1,044","Doc 18"]], "founded 1771"),
 ...
 ("Santa Bárbara (mission)", [34.4378, -119.7137],
  [["1787","183 (first inventory)","C-A 50 Doc 14"],["1788","361","Doc 16"],["1789","525","Doc 18"]], "founded 1786"),
...
out = {
    ...
    "subtitle": "Every count in the archive: padrones, censos, and mission registros, 1782–1833",
